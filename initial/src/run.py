...
def main(argv):
    if len(argv) < 1:
    ...
    elif argv[0] == 'test' or argv[0] in ['tLex', 'tParse', 'tAST', 'tCheck', 'tGen']:
        ...
        if len(argv) < 2 and argv[0] == 'test':
            printUsage()
        elif argv[0] == 'tLex' or (len(argv) == 2 and argv[1] == 'LexerSuite'):
            from LexerSuite import LexerSuite
            getAndTest(LexerSuite)
        elif argv[0] == 'tParse' or (len(argv) == 2 and argv[1] == 'ParserSuite'):
            from ParserSuite import ParserSuite
            getAndTest(ParserSuite)
        elif argv[0] == 'tAST' or (len(argv) == 2 and argv[1] == 'ASTGenSuite'):
            from ASTGenSuite import ASTGenSuite
            getAndTest(ASTGenSuite)
        elif argv[0] == 'tCheck' or (len(argv) == 2 and argv[1] == 'CheckerSuite'):
            from CheckerSuite import CheckerSuite
            getAndTest(CheckerSuite)
        elif argv[0] == 'tGen' or (len(argv) == 2 and argv[1] == 'CodeGenSuite'):
